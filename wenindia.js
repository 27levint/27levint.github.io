(function(){
  ...
  const myQuestions = [
    {
      question: "When a ruler gives up their power/throne...",
      answers: {
        a: "Abdicate",
        b: "Stupa",
        c: "Bureaucracy"
    ...
    {
      question: "To know right from wrong ways of behavior...",
      answers: {
        a: "Boycott",
        b: "Edict",
        c: "Moral"
    ...
    {
      question: "A rebellion against authority...",
      answers: {
        a: "Mutiny",
        b: "Monolith",
    ...
    {
      question: "Relates to ocean navigation or sea trade...",
      answers: {
        a: "Sultanate",
        b: "Maritime",
        c: "Monopoly"
